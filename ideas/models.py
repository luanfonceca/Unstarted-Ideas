...
# class Idea(Model):
#     name = CharField(max_length=100, verbose_name=_('Name'))
#     slug = AutoSlugField(max_length=100, unique=True, blank=True, verbose_name=_('Slug'))
#     created_at = CreationDateTimeField(verbose_name=_('Date Created'))
#     modified_at = ModificationDateTimeField(verbose_name=_('Date Modified'))
#     description = TextField(max_length=300, verbose_name=_('Description'))
#     is_public = BooleanField(default=False, verbose_name=_('Is Public'))
#     is_published = BooleanField(default=False, verbose_name=_('Pusblish Now'))
#     views = PositiveIntegerField(verbose_name=_('Amount of Views'))
...
#     user = ForeignKey(to=User, related_name='ideas', verbose_name=_('Author'))
#     categories = ManyToManyField(to=Category, related_name='ideas', verbose_name=_('Category'))
